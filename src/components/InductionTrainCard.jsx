...
const InductionTrainCard = ({ train, selected, onClick }) => {
    ...
    return (
        <div
            className={`relative flex items-center justify-between p-3 border-t border-b ${borderColor} bg-white transition mb-2 cursor-pointer ${selectedStyle}`}
            onClick={() => onClick && onClick(train.trainId)}
        >
